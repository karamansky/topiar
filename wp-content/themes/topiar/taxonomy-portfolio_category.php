<?php
	...
	$text = get_field('portfolio_seo_text', 'option');
?>
			...
			<div class="portfolio__content">
				...
				<?php if( have_posts() ) { ?>
					<div class="portfolio__box">
						<h2 class="portfolio__category-title">
							<?php
								if ( is_tax() ) {
									echo $the_term->name;
								} else {
						...
						<div class="portfolio__category-wrap">
							<ul class="portfolio__category-menu">
								<li class="menu-item"><a href="<?php echo $portfolio_link; ?>"><?php _e('Всі', 'tp'); ?></a></li>
								<?php if( !empty($terms) && !is_wp_error($terms) ) { ?>
									...
									?>
										<li class="menu-item <?php echo $active_class; ?>"><a href="<?php echo get_term_link($item); ?>"><?php echo $item->name; ?></a></li>
									<?php } ?>
								<?php } ?>
							</ul>
						</div>
